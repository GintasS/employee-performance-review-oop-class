...
public class EmployeeModelBuilder {
    ...
    public Employee build(String firstName, String lastName, Team team, PerformanceRating rating, EmployeeType employeeType, BigDecimal yearlySalary, int employmentTime, List<BigDecimal> yearlyBonuses) {
    ...
    public Employee build(UUID id, String firstName, String lastName, Team team, PerformanceRating rating, EmployeeType employeeType, BigDecimal yearlySalary, int employmentTime, List<BigDecimal> yearlyBonuses) {
